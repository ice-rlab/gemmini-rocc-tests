...
//     gemmini_extended_mvin2(In[(n + 1)], (n + 1)*DIM, DIM, DIM);
//     gemmini_extended_mvin3(In[(n + 2)], (n + 2)*DIM, DIM, DIM);
...
//         break;
//     case 1:
//         gemmini_extended_mvin2(In[n], n*DIM, DIM, DIM);
//         break;
//     case 2:
//         gemmini_extended_mvin3(In[n], n*DIM, DIM, DIM);
//         break;
//     }
  //}
