...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 2 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        conv_cycles += end - start;
        printf("conv 3 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 4 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 5 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
printf("res_add 1 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 6 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        conv_cycles += end - start;
        printf("conv 7 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 8 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
    res_add_cycles += end - start;
printf("res_add 2 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 9 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        conv_cycles += end - start;
        printf("conv 10 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 11 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
    res_add_cycles += end - start;
printf("res_add 3 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 12 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        conv_cycles += end - start;
        printf("conv 13 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 14 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        conv_cycles += end - start;
        printf("conv 15 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
    res_add_cycles += end - start;
printf("res_add 4 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 16 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        conv_cycles += end - start;
        printf("conv 17 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 18 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
    res_add_cycles += end - start;
printf("res_add 5 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 19 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        conv_cycles += end - start;
        printf("conv 20 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 21 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
    res_add_cycles += end - start;
printf("res_add 6 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 22 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        conv_cycles += end - start;
        printf("conv 23 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 24 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
    res_add_cycles += end - start;
printf("res_add 7 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 25 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        conv_cycles += end - start;
        printf("conv 26 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 27 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        conv_cycles += end - start;
        printf("conv 28 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
    res_add_cycles += end - start;
printf("res_add 8 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 29 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        conv_cycles += end - start;
        printf("conv 30 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 31 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
    res_add_cycles += end - start;
printf("res_add 9 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 32 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        conv_cycles += end - start;
        printf("conv 33 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 34 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
    res_add_cycles += end - start;
printf("res_add 10 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 35 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        conv_cycles += end - start;
        printf("conv 36 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 37 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
    res_add_cycles += end - start;
printf("res_add 11 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 38 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        conv_cycles += end - start;
        printf("conv 39 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 40 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
    res_add_cycles += end - start;
printf("res_add 12 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 41 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        conv_cycles += end - start;
        printf("conv 42 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 43 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
    res_add_cycles += end - start;
printf("res_add 13 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 44 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        conv_cycles += end - start;
        printf("conv 45 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 46 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        conv_cycles += end - start;
        printf("conv 47 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
    res_add_cycles += end - start;
printf("res_add 14 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 48 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        conv_cycles += end - start;
        printf("conv 49 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 50 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
    res_add_cycles += end - start;
printf("res_add 15 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 51 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        conv_cycles += end - start;
        printf("conv 52 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
        matmul_cycles += end - start;
        printf("matmul 53 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
    }
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
    res_add_cycles += end - start;
printf("res_add 16 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
    ...
    printf("global averaging cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
...
wdma_bytes_sent_end = counter_read_extra(WDMA_BYTES_SENT - 1);
    matmul_cycles += end - start;
    printf("matmul 54 cycles: %llu, total_macs = %u, bytes_loaded_a = %u, bytes_loaded_b = %u, bytes_loaded_d = %u, bytes_read = %u, rdma_bytes_rec = %u, wdma_bytes_sent = %u\n", end-start, total_macs_end - total_macs_start, bytes_loaded_a_end - bytes_loaded_a_start, bytes_loaded_b_end - bytes_loaded_b_start, bytes_loaded_d_end - bytes_loaded_d_start, bytes_read_end - bytes_read_start, rdma_bytes_rec_end - rdma_bytes_rec_start, wdma_bytes_sent_end - wdma_bytes_sent_start);
