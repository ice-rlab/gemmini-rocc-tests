...
#define INCREMENTAL_COUNTERS 51
...
#define EXE_ONLY_PRELOAD_CYCLE 45
#define EXE_OVERLAPING_CYCLE 46
#define EXE_ONLY_MATMUL_CYCLE 47

#define MATMUL_IN_PROGRESS 48
#define MAC_BUSY 49

#define STREAM_READER_BUSY 50
#define STREAM_WRITER_BUSY 51
...
#define TOTAL_MACS (INCREMENTAL_COUNTERS + 8)

#define PROFILING_SUM_A (INCREMENTAL_COUNTERS + 9)
#define PROFILING_SUM_B (INCREMENTAL_COUNTERS + 10)
#define PROFILING_SUM_D (INCREMENTAL_COUNTERS + 11)

#define BYTES_LOADED_A (INCREMENTAL_COUNTERS + 12)
#define BYTES_LOADED_B (INCREMENTAL_COUNTERS + 13)
#define BYTES_LOADED_D (INCREMENTAL_COUNTERS + 14)
#define BYTES_READ (INCREMENTAL_COUNTERS + 15)
