...
#include "include/gemmini_fp_to_int.h"
...
//   	fp_counter_configure_extra(i, i + 1);
...
//   }
	...
	// fp_gemmini_config_ld(array_dim * sizeof(fp_elem_t));
	...
	// fp_elem_t FP_A[array_dim][array_dim];
        // fp_elem_t FP_B[array_dim][array_dim];
        // fp_elem_t FP_D[array_dim][array_dim];

        // acc_t FP_C[array_dim][array_dim];
...
// 	printf("\n");
	...
	//printf("Here A");
	fp_to_int_tiled_matmul_auto(array_dim, array_dim, array_dim,
            (void*)A, (void*)B,
	    &D[0][0], (acc_t*)C,
...
//       unsigned long end = read_cycles();
	// printf("STATS\n\nCycles taken: %u\n", end-start);
//     int total_macs = array_dim * array_dim * array_dim;
...
//     	}
// 	start = fp_read_cycles();
// 	// TODO:
// 	// MAKE SURE TILED MATMUL AUTO PARAMETERS ARE CORRECT
// 	// MAKE A "COUNTER" VERSION OF THIS FUNCTION
// 	// FIX BUG WHERE THE OUTPUT IS JUST MAXED OUT
// 	//printf("Here A");
// 	fp_tiled_matmul_auto(array_dim, array_dim, array_dim,
...
//       end = fp_read_cycles();
// 	printf("STATS\n\nCycles taken: %u\n", end-start);
//     total_macs = array_dim * array_dim * array_dim;
