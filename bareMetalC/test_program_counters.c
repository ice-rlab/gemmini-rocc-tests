...
int main() {
  ...
  int counter_val_0 = counter_read(0);
  int counter_val_1 = counter_read(1);
  int counter_val_2 = counter_read(2);
  int counter_val_3 = counter_read(3);
  int counter_val_4 = counter_read(4);
  int counter_val_5 = counter_read(5);

  printf("Counters before preload: EXE_ACTIVE_CYCLE: %d, EXE_FLUSH_CYCLE: %d, EXE_CONTROL_Q_BLOCK_CYCLE: %d, EXE_PRELOAD_HAZ_CYCLE: %d, EXE_OVERLAP_HAZ_CYCLE: %d, MAIN_EX_CYCLES: %d\n", counter_val_0, counter_val_1, counter_val_2, counter_val_3, counter_val_4, counter_val_5);
  ...
  counter_val_0 = counter_read(0);
  counter_val_1 = counter_read(1);
  counter_val_2 = counter_read(2);
  counter_val_3 = counter_read(3);
  counter_val_4 = counter_read(4);
  counter_val_5 = counter_read(5);

  printf("Counters after preload: EXE_ACTIVE_CYCLE: %d, EXE_FLUSH_CYCLE: %d, EXE_CONTROL_Q_BLOCK_CYCLE: %d, EXE_PRELOAD_HAZ_CYCLE: %d, EXE_OVERLAP_HAZ_CYCLE: %d, MAIN_EX_CYCLES: %d, a: %d\n", counter_val_0, counter_val_1, counter_val_2, counter_val_3, counter_val_4, counter_val_5, a);
